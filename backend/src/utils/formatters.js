...
export const formatUser = (userDoc) => {
  ...
  return {
    ...
    orderingRestrictedUntil: user.ordering_restricted_until,
    lastNoShowAt: user.last_no_show_at,
...
export const formatOrder = (orderDoc, extras = {}) => {
  ...
  return {
    ...
    isCommitmentConfirmed: order.is_commitment_confirmed,
    commitmentConfirmedAt: order.commitment_confirmed_at,
    commitmentDeadlineAt: order.commitment_deadline_at,
    readyAt: order.ready_at,
    readyExpiresAt: order.ready_expires_at,
    cancelledAt: order.cancelled_at,
    cancellationReason: order.cancellation_reason,
    noShowRecorded: order.no_show_recorded,
    ...
    store_qr_code_url: store?.qr_code_url || order.store_qr_code_url,
    storeQrCodeUrl: store?.qr_code_url || order.store_qr_code_url,
