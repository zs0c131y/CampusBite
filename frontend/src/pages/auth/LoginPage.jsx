  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-transparent px-4 py-12">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-20 left-[8%] h-56 w-56 rounded-full bg-orange-200/20 blur-3xl" />
        <div className="absolute bottom-[-6rem] right-[8%] h-64 w-64 rounded-full bg-amber-300/18 blur-3xl" />
      </div>
      ...
      <div className="w-full">
        ...
        <Card className="border border-border/80 bg-card/90 shadow-[0_20px_34px_-26px_rgba(32,23,15,0.65)] backdrop-blur-sm">
